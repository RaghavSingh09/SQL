					...
					--Start for Deliverable
												INSERT INTO GPM_WT_Project_Deliverable 
													...
													SELECT 
															...
															@_vCreated_By,
															TDGD.System_end_date
															FROM Temp_PSC_Gate_Deliverable TDGD INNER JOIN GPM_Gate_Deliverable GGD 
															On 
													...
													SELECT 
														...
														'N'
													FROM	Temp_PSC_Gate_Deliverable TDGD INNER JOIN GPM_Gate_Deliverable GGD  INNER JOIN GPM_Gate GG On GGD.Gate_Id=GG.Gate_Id
															On RTRIM(LTRIM(TDGD.Gate_Name))=GG.Gate_Desc AND
