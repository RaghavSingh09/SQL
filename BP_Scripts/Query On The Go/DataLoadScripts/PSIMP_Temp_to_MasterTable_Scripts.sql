...
DECLARE @_vProject_Description varchar(2000)
			...
			--Start for Deliverable
												INSERT INTO GPM_WT_Project_Deliverable 
													...
													SELECT 
															...
															@_vCreated_By,
															TDGD.System_end_date
															FROM Temp_PSIMP_Gate_Deliverable TDGD INNER JOIN GPM_Gate_Deliverable GGD 
															On 
																				-- Case use when flat file Deliverable_Name  is not matching with Master table Deliverable_Name 
