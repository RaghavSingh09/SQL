...
DECLARE QTI_Cursor CURSOR FOR
					...
					FROM
					Temp_QTI_Custom_Fields-- WHERE Sequence_number='RD-00036'
				...
				ELSE
					...
					PRINT @_vSequence_number +'Yes'
							...
							(
								...
								Agent_Company_Name,Agent_Contatc_Name,Agent_Email,Agent_Phone
								,
								
								PTM_Lead_Time,CSIS_Desc,Vendor_Code,Required_Doc,Mat_Ship_Once,Comments,SIS_New_Supp,Supp_Requirement_Acpt,Supp_Requirement_Excpt
								,
								PLS_Concept_Check,SQA_S1_Supp_Requirement,SQA_S1_Concept_Check,Supp_Complaint,Plant_Raw_Mat_Plan
								,
								
								SC_S1_Supp_Requirement,Packaging_Requirement,Packaging_Req_Met,Mode_Requirement
								,
								Mode_Requirement_Met,Import_License_Required,Proc_Trial_Required,
								--Total_Qty_Need,
								Plant_Tech_Contact
								,Intermediate_Dest,QA_S1_Supp_Requirement,COA_PPK_Data_Need,Beyond_Spec_Data_Need,
								Plant_Spec_Requirement,Other_Trial_Required,Trial_Desc
								
								,Trial_Treatment,Dipped_Fabric_Width,Spool_Length,Spool_Type,VPS_Template,Proc_Vol_Trial_Duration,Product_Group_Id,Tech_Req_Data_Need
								,
							...
							(
								...
								@_vAgent_Company_Name,@_vAgent_Contact_Name,@_vAgent_Email,@_vAgent_Phone_Number
								,@_vLead_Time_for_Process_Trial_Material_No_of_days,--@_vPTM_Lead_Time,
								@_vCSIS_#,@_vVendor_Code,
								CASE WHEN @_vDoes_Supplier_have_Required_Import_Documentation='Yes' THEN 'Y' WHEN @_vDoes_Supplier_have_Required_Import_Documentation='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vWill_the_supplier_ship_all_material_at_once='Yes' THEN 'Y' WHEN @_vWill_the_supplier_ship_all_material_at_once='No' THEN 'N' ELSE NULL END,
								@_vComments
								,@_vSIS_Material_Code_New_Supplier_,@_vSupplier_requirements_accepted,
								@_vIf_no_note_supplier_requirements_exceptions,@_vProject_Leader_Concept_Check,@_vSQA_Stage_1_Supplier_Requirements,@_vSQA_Stage_1_Concept_Check,CASE WHEN @_vSupplier_compliant_in_SIS ='Yes' THEN 'Y' WHEN @_vSupplier_compliant_in_SIS='No' THEN 'N' ELSE NULL END  ,@_vPlant_Raw_Material_Planner
								,
								@_vSupply_Chain_Stage_1_Supplier_Requirements,@_vPackaging_Requirements,CASE WHEN @_vSupplier_meets_packaging_requirement='Yes' THEN 'Y' WHEN @_vSupplier_meets_packaging_requirement='No' THEN 'N' ELSE NULL END
								,--@_vPackaging_Req_Met,
								@_vMode_Requirements,
								CASE WHEN @_vSupplier_meets_mode_requirement='Yes' THEN 'Y' WHEN @_vSupplier_meets_mode_requirement='No' THEN 'N' ELSE NULL END,--@_vMode_Requirement_Met,
								CASE WHEN @_vImport_License_Required='Yes' THEN 'Y' WHEN @_vImport_License_Required='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vProcessing_trial_required='Yes' THEN 'Y' WHEN @_vProcessing_trial_required='No' THEN 'N' ELSE NULL END,
								--@_vTotal_quantity_needed_units,
								@_vPlant_Technical_Contact,@_vIntermediary_Destination_if_Applicable,@_vQuality_Stage_1_Supplier_Requirements,
								@_vCOA_ppk_data_needed_,@_vData_needs_beyond_the_specification,@_vPlant_Specific_Requirements,
								CASE WHEN @_vAre_there_other_trials_that_require_this_material='Yes' THEN 'Y' WHEN @_vAre_there_other_trials_that_require_this_material='No' THEN 'N' ELSE NULL END,
								@_vIf_yes_what_trials--@_vTrials,
								,@_vCompound_Treatment_for_trial,--@_vTrial_Treatment,
								@_vDipped_Fabric_Width,@_vSpool_Length,@_vSpool_Type,@_vVPS_Template,@_vProcessing_and_Volume_trial_durations,@_vProduct_Group_Id,@_vDescribe_any_technical_requirements_or_data_needs_
								,CASE WHEN @_vGoodyear_specification_sent='Yes' THEN 'Y' WHEN @_vGoodyear_specification_sent='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vGoodyear_test_methods_sent='Yes' THEN 'Y' WHEN @_vGoodyear_test_methods_sent='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vSupplier_specification_needed='Yes' THEN 'Y' WHEN @_vSupplier_specification_needed='No' THEN 'N' ELSE NULL END,
								NULL,--@_vSupplier_Test_Method_Need,
								@_vGMS_Stage_2_Testing_Requirements,@_vQTY_of_Tires_per_Trial,@_vTire_SKU_for_trial,
								CASE WHEN @_vPlant_volume_trial_needed='Yes' THEN 'Y' WHEN @_vPlant_volume_trial_needed='No' THEN 'N' ELSE NULL END,
								@_vYarn_Type,@_vConstruction_dtex,@_vTwist,@_vTotal_Ends,@_vEPI,
								@_vTreatment_Width_suffix,@_vDiff_bw_GY_Supplier_Specs_or_test_methods,@_vSupplier_is_capable_to_meet_Goodyear_requirements,
								CASE WHEN @_vHas_supplier_signed_the_specification='Yes' THEN 'Y' WHEN @_vHas_supplier_signed_the_specification='No' THEN 'N' ELSE NULL END,--@_vSupp_Sign,
								@_vProduct_Stewardship_Stage_1_Supplier_Requirements,
								CASE WHEN @_vSDS_Needed='Yes' THEN 'Y' WHEN @_vSDS_Needed='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vSDS_Received='Yes' THEN 'Y' WHEN @_vSDS_Received='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vSDS_Ok='Yes' THEN 'Y' WHEN @_vSDS_Ok='No' THEN 'N' ELSE NULL END,
								
								 CASE WHEN @_vCIRF_Needed='Yes' THEN 'Y' WHEN @_vCIRF_Needed='No' THEN 'N' ELSE NULL END,
								 CASE WHEN @_vCIRF_Received='Yes' THEN 'Y' WHEN @_vCIRF_Received='No' THEN 'N' ELSE NULL END,
								
								
								
								CASE WHEN @_vREACH_andor_Inventory_Status_OK='Yes' THEN 'Y' WHEN @_vREACH_andor_Inventory_Status_OK='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vHAP_free_letter_needed='Yes' THEN 'Y' WHEN @_vHAP_free_letter_needed='No' THEN 'N' ELSE NULL END,
								CASE WHEN @_vEHS_Process_Questions_needed='Yes' THEN 'Y' WHEN @_vEHS_Process_Questions_needed='No' THEN 'N' ELSE NULL END,
